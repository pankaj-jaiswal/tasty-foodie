        ...
        return(
          <div>
             ...
             <UserContext.Consumer>
               { ({logInUser}) => <h2 className="font-bold">{logInUser}</h2>}
             </UserContext.Consumer>
             </div>
            <h2>Hello it is about us</h2>
            <UserClass name={"first "} Location={"Pune"} age={25}/>
            <UserClass name={"second "} Location={"Pune"} age={25}/>
...
import Poster from "../utils/image/poster.jpg";
            ...
            <div className="bg-orange-600 w-14 h-1 self-center"></div>
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <div className="mt-10 flex flex-col items-center md:flex-row">
                        ...
                        <a href="https://www.linkedin.com/in/pankaj-kumar-jaiswal-298863209/" target="_blank" className="group inline-flex items-center font-semibold text-g1">My Linkedin
